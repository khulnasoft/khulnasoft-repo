...
- (void)setDockTile:(NSDockTile*)dockTile
{
    if (dockTile) {
        ...
        _userDefaults = [[NSUserDefaults alloc] initWithSuiteName:@"corp.khulnasoft.privileges"];
        ...
        _privilegesObserver = [[NSDistributedNotificationCenter defaultCenter] addObserverForName:@"corp.khulnasoft.PrivilegesChanged"
                                                                                           object:_currentUser
                                                                                            queue:nil
        ...
        _timeoutObserver = [[NSDistributedNotificationCenter defaultCenter] addObserverForName:@"corp.khulnasoft.PrivilegesTimeout"
                                                                                        object:_currentUser
                                                                                         queue:nil
                                                                                    usingBlock:^(NSNotification *notification) {
...
- (void)startToggleTimer
{
    ...
    // or in the Privileges preferences
        ...
        NSString *privilegesPrefsPath = [NSHomeDirectory() stringByAppendingPathComponent:@"/Library/Containers/corp.khulnasoft.privileges/Data/Library/Preferences/corp.khulnasoft.privileges"];
...
- (void)sendBadgeUpdateNotification
{
    ...
    [[NSDistributedNotificationCenter defaultCenter] postNotificationName:@"corp.khulnasoft.PrivilegesTimeout"
                                                                   object:_currentUser
                                                                 userInfo:nil
