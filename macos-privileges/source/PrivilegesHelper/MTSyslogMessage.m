...
@property (atomic, assign) struct MTSyslogMessageParts msgParts;
@end
...
- (NSString* _Nullable)messageString
{
    ...
    if ([_msgParts.msg length] > 0) {
        ...
        [timestampFormatter setLocale:enUSPOSIXLocale];
        ...
        if ([_msgParts.hostname length] > 0) {
            ...
            [finalMessage appendFormat:@"\357\273\277%@", _msgParts.msg];
            ...
            if (finalMessageLength > _msgParts.max_size) {
                ...
                finalMessage = [truncatedString mutableCopy];
            }
